                    ...
                    <div class="mt-10 px-12 sm:px-24 md:px-48 lg:px-12 lg:mt-16 xl:px-24 xl:max-w-2xl">
                        ...
                        <div class="mt-12">
                            <form>
                                ...
                                <div class="mt-8">
                                    <div class="flex justify-between items-center">
                                        ...
                                        <div>
                                            <a class="text-xs font-display font-semibold text-purple-600 hover:text-purple-800
                                            cursor-pointer">
                                                Forgot Password?
                                            </a>
                                        </div>
                            ...
                            <div class="mt-12 text-sm font-display font-semibold text-gray-700 text-center">
                                Don't have an account ? <a class="cursor-pointer text-purple-600 hover:text-purple-800" href="/register">Register</a>
                            </div>
                        </div>
                    </div>
                </div>
